...
function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-[120] flex h-14 w-14 items-center justify-center rounded-full border border-white/30 bg-[#25d366] text-white shadow-[0_18px_38px_rgba(37,211,102,0.34)] transition hover:bg-[#1ebe5d] hover:shadow-[0_22px_44px_rgba(37,211,102,0.38)] sm:bottom-8 sm:right-8 sm:h-[60px] sm:w-[60px]"
    >
      <svg
        viewBox="0 0 24 24"
